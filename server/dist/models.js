...
exports.CHAT_MODELS = exports.modelAliases = exports.OPENROUTER_FREE_MODELS = void 0;
...
exports.CHAT_MODELS = [...exports.OPENROUTER_FREE_MODELS];
// Model lookup by ID
function getModelById(modelId) {
    const resolvedId = resolveModelId(modelId);
    return exports.CHAT_MODELS.find(m => m.id === resolvedId);
}
// Resolve model ID (apply aliases)
function resolveModelId(modelId) {
    const normalized = modelId.trim().toLowerCase().replace(/^['"]+|['"]+$/g, '');
    return exports.modelAliases[normalized] || normalized;
}
